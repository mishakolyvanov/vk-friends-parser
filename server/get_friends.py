...
db = database("cgi-bin/db.db")

def get_friends(user_ids):
    for user_id in user_ids:
        friends = find_friend(user_id)
        db_update(user_id, friends)
    return db.intersect(user_ids)

# user_ids = [282459633, 188332194, 156274337]

def find_friend(user_id):
    return requests.post("https://api.vk.com/method/friends.get?user_id=" + (user_id) + "&count=50000&access_token=c33ee727c33ee727c33ee7276ac346c148cc33ec33ee727a380d50e2346b8c14b666056&v=5.131").json()
